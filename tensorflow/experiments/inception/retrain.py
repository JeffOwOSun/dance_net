...
from bottleneck import get_random_cached_bottlenecks, cache_bottlenecks
...
def create_inception_graph():
  ...
  with tf.Session() as sess:
    ...
    with gfile.FastGFile(model_filename, 'rb') as f:
      ...
      #raw_input('ochinchin')
      '''
      tf.import_graph_def takes a serialized GraphDef object and convert it into
      a Graph object. Presumably, this Graph object is saved to sess.graph
      '''
...
def main(_):
  ...
  ''' CUSTOM: summaries '''
  summary = tf.merge_all_summaries('summary')

  #print('graph:', dir(graph))
  #raw_input('666')
  # Look at the folder structure, and create lists of all the images.
  # splitting of subsets happen here
